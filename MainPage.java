...
public class MainPage {
	...
	//settings leads
	public static final String prefsStatus_first_Locator = "button.edit";
	...
	public static final String prefsStatusSave_Locator = "div#lead-status button.save";
	@FindBy(css = prefsStatusSave_Locator)
	private WebElement prefsStatusSave;
	
	// leads - main list
	 
	@FindBy(css="ul.filter-categories li.status-filter a.filter-heading")
	private WebElement leadsFilter_header;
	...
	private void openPrefsLeadsStatus() {
		...
		(new WebDriverWait(driver, 10)).until(ExpectedConditions.visibilityOf(prefsStatus_firstButton));
